...
const defaultTasks=[
 ...
 {date:'27.09',place:'Samui Pier Beach Front Resort',title:'לוודא מונית לשדה לבוקר',status:'open',detail:'לבקש מהקבלה לאשר מונית ל-28.9 בשעה 06:45. אם אין אישור, להזמין Grab ולבחור Samui Airport כיעד.',actions:[['פתיחת Grab','https://www.grab.com/th/en/download/'],['ניווט לשדה קוסמוי','https://www.google.com/maps/dir/?api=1&origin=Samui+Pier+Beach+Front+Resort&destination=Samui+Airport']]},
 ...
 {date:'28.09',place:'פאי',title:'להזמין מלון ללילה שמתחיל ב-29.9',status:'open',detail:'לחפש מלון ליד מרכז פאי או Walking Street, לבדוק ביטול חינם ומקום לשמירת התיק, ואז לשמור את השובר במסמכים.',actions:[['מלונות במרכז פאי','https://www.google.com/maps/search/?api=1&query=hotels+near+Pai+Walking+Street'],['פתיחת Booking','https://www.booking.com/searchresults.html?ss=Pai%2C+Thailand']]},
 {date:'29.09',place:'Rawee Arun Hotel',title:'לתאם שמירת המזוודה',status:'open',detail:'בבוקר לבקש בקבלה לשמור את המזוודה הגדולה עד החזרה מפאי. לצלם את תג השמירה ולקחת לפאי רק תיק קטן.',actions:[['ניווט למלון','https://www.google.com/maps/search/?api=1&query=Arun+Rawee+Chiang+Mai']]},
 ...
 {date:'01.10',place:'פאי ← צ׳יאנג מאי',title:'להזמין ואן חזרה לצ׳יאנג מאי',status:'open',detail:'לפתוח 12Go, לבחור Pai to Chiang Mai בתאריך 1.10 ושעה קרובה ל-09:00. לוודא הגעה לפני הטיסה, כבודה ונקודת הורדה, לשלם ולשמור שובר.',actions:[['הזמנה ב-12Go','https://12go.asia/en/travel/pai/chiang-mai'],['תחנת האוטובוסים בפאי','https://www.google.com/maps/search/?api=1&query=Pai+Bus+Station']]},
